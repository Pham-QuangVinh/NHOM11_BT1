...
public class OtpVerifyActivity extends AppCompatActivity {
    ...
    private String source;   // "signup" | "forgot" (mặc định: forgot)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        otp    = getIntent().getStringExtra("otp");      // có thể null nếu chưa truyền
        source = getIntent().getStringExtra("source");   // "signup" nếu từ SignUp; null/khác = forgot
    ...
    private void onVerify() {
        ...
        if (otp == null || code.equals(otp)) {
            ...
            if ("signup".equals(source)) {
                // Luồng ĐĂNG KÝ: sang trang thành công
                Intent i = new Intent(this, RegisterSuccessActivity.class);
                i.putExtra("email", email);
                startActivity(i);
                // Không cần finish() nếu muốn back về OTP, tuỳ bạn
            } else {
                // Luồng QUÊN MẬT KHẨU: sang đổi mật khẩu
    ...
    private void onResend() {
        ...
        Snackbar.make(binding.tvResend, "Đã 'gửi lại' OTP demo: " + otp, Snackbar.LENGTH_LONG)
                .setDuration(10_000) // kéo dài 10s cho dễ đọc
                .show();
    ...
    private void setLoading(boolean b) {
        ...
        setOtpEnabled(!b);
        // resend chỉ enable khi không loading & hết countdown (đã xử lý trong timer)
    }
    ...
    private void clearOtp() {
        for (EditText ed : boxes()) ed.setText("");
    }
    ...
    private void setupOtpBoxes() {
        ...
        // Cho phép dán 6 số vào ô đầu → tự phân bổ
